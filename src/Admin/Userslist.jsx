...
function Userslist() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get('http://localhost/vechilebackend/controllers/api/User/Get/two.php');
  ...
  const handleSaveClick = async () => {
    try {
      await axios.put(
        `http://localhost/vechilebackend/controllers/api/admin/put/twoupdate.php`,
        editFormData
      );
      setUsers((prevUsers) =>
        prevUsers.map((user) =>
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.post(
        `http://localhost/vechilebackend/controllers/api/admin/delete/two.php`,
        { id }
      );
